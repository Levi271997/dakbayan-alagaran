<?php
    ...
    if($rescount){
        ...
        $queryinsert="INSERT INTO tblregistration (userid, first_name , middle_name , last_name , suffix , personnel_id , img , level_status , gender , civil_status , b_date , age , baranggay , zone , street , voter , phone , email , occupation , date_of_registration , password,status,member_status)VALUES('$newuseridval','$fname','$mname','$lname','$suffix','$loggedinid','','member','$gender','$status','$birthdate','$age','$barangay','$zone','$saddress','$voter','$phone','$email','$work','$dateofreg','','1','1')";
        ...
        if(mysqli_query($dbc,$queryinsert)){
           ...
           if($getday > 30){
             ...
             $quer2="INSERT INTO tblpayment(dateofpayment,yearofpayment,typeofpayment,payerid,coorid,status,resetStats) VALUES ('$dateofreg','','2','$last_id','$loggedinid','0','0')";
           ...
           for($x = 0;$x < $classlists; $x++){ 
               ...
               if(empty($quer)){    
                   ...
                   $quer = "INSERT INTO tblpayment(dateofpayment,yearofpayment,typeofpayment,payerid,coorid,status,resetStats) VALUES ('$dateofreg','','1','$last_id','$loggedinid','0','0')";
                  ...
                  $d = new DateTime($dateofreg);   
                   ...
                   if( $modifieddate <= 29){                                     
                       ...
                       $quer = "INSERT INTO tblpayment(dateofpayment,yearofpayment,typeofpayment,payerid,coorid,status,resetStats) VALUES ('$final','','1','$last_id','$loggedinid','0','0')";      
